...
#define MIRYOKU_LAYOUTMAPPING_TOTEM( \
     ...
     K00  K01  K02  K03  K04       K05  K06  K07  K08  K09 \
     K10  K11  K12  K13  K14       K15  K16  K17  K18  K19 \
&kp PG_UP  K20  K21  K22  K23  K24       K25  K26  K27  K28  K29  &kp PG_UP \
...
&mt LCTRL Z,       &mt LALT X,        &mt LSHIFT C,      &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_TAP, PG_DN),  &kp TAB,           &kp SPACE,         U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_LAYER_TAP \
&mt ESC N1,        &kp N2,            &kp N3,            &kp N4,            &kp N5,            &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
